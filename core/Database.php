...
class Database
{
    ...
    public static function getPdo(): PDO
    {
        ...
        if (!self::$pdo) {
            // On définit ici les paramètres de connexion
            $dsn = 'mysql:host=localhost;dbname=livreor;charset=utf8mb4'; // On utilise notre database 'livreor' 
            $user = 'root';  // Login par défaut pour Laragon
            $pass = ''; // Mot de passe par défaut pour Laragon
